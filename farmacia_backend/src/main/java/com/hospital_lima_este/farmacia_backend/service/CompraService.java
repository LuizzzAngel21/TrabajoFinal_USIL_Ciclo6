...
public class CompraService {
    ...
    public List<OrdenCompraDTO> listarOrdenes() {
        ...
        return ordenes.stream().map(orden -> OrdenCompraDTO.builder()
                ...
                .proveedorNombre(orden.getProveedor() != null ? orden.getProveedor().getNombreProveedor() : "Sin Proveedor")
    ...
    public void generarOrdenCompra(Integer idSolicitud, Integer idProveedor, BigDecimal precioTotalIgnorado) {
        ...
        if (idSolicitud == null || idProveedor == null) {
            throw new IllegalArgumentException("IDs no pueden ser nulos. Solicitud: " + idSolicitud + ", Proveedor: " + idProveedor);
        }
        ...
        for (DetalleSolicitudCompra detSol : detallesSolicitud) {
            ...
            ProductoProveedor prodProv = productoProveedorRepository.findByProductoAndProveedor(detSol.getProducto(), proveedor)
