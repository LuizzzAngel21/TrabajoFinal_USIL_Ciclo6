...
export class AppRoutes {} // Solo por si acaso
...
export const routes: Routes = [
    ...
    // En lugar de mandarlo a 'requerimientos' directo, lo mandamos a 'login' 
    // (El login sabrá redirigir si ya estás autenticado)
